            ...
            <div className="w-1/2 border-x border-y rounded shadow-lg px-4 py-4">
                <div className="border-b border-b-gray-400">
                    ...
                    <div className="p-4 text-sm text-gray-700">
                        ...
                        <p className="mt-2">
                            ...
                            doubt I ate for 2 years and didn't have to complain
                            any, not even once.
                        </p>
                    </div>
                </div>
                <div className="mt-4">
                    ...
                    <div className="p-4 text-sm text-gray-700">
                        ...
                        <p className="mt-2">
                            I firstly liked it very much but after some 2-3
                            months, the quality of food deteriorated, I
                            complained but it didn't improve to it's previous
                            one. So yeah a mixed response.
                        </p>
                    </div>
                </div>
            </div>
